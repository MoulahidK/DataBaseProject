...
try:
    ...
    if connection.is_connected():
        ...
        for i,row in emported_data.iterrows(): # Inserting each Dataframe row to the table row
            sql = "INSERT INTO `LOL`.`match2` VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
